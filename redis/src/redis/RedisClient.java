...
public class RedisClient {
    ...
    private ShardedJedisPool shardedJedisPool;//切片连接池,基于一致性哈希算法实现的分布式Redis集群客户端
    ...
    { 
        ...
        JedisShardInfo infoA=new JedisShardInfo("127.0.0.1", 6379, "master");
        shards.add(infoA); 
    ...
    public void show() {     
        ...
        SortedSetOperate();
        HashOperate(); 
        jedisPool.close();//  jedisPool.returnResource(jedis);
